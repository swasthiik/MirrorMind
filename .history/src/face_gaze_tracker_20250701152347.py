...
class FaceGazeTracker:
    ...
    def track_gaze(self):
        ...
        gaze_info = {
            ...
            "scroll_detected": False   # Reserved for hand gesture
        }
        ...
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                gaze_info["eyes_detected"] = True  # Since iris found, eyes are open
    ...
    def _draw_robo_eye(self, frame, center, color=(0, 180, 255)):
        """Draw glowing cyber eye with concentric neon rings"""
        x, y = center
        glow_layers = 4
        base_radius = 8
