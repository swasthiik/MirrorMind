...
class FaceGazeTracker:
    ...
    def draw_robo_eye(self, frame, center, radius=30):
        ...
        cv2.circle(overlay, center, radius - 10, (255, 255, 255), 1)

        # Center point
        cv2.circle(overlay, center, 5, (0, 0, 255), -1)

        # Crosshairs
        cv2.line(overlay, (center[0] - 10, center[1]), (center[0] + 10, center[1]), (255, 100, 100), 1)
        cv2.line(overlay, (center[0], center[1] - 10), (center[0], center[1] + 10), (255, 100, 100), 1)
        ...
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                for (ex, ey, ew, eh) in eyes:
                    ...
                    self.draw_robo_eye(frame, eye_center, radius=ew // 2)
