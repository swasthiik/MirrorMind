...
class FaceGazeTracker:
    ...
    def stream_gaze_overlay(self, loop_type="Normal", pattern="DetectedGazePattern", context="Working", break_suggested="No", max_duration=10):
        ...
        while time.time() - start_time < max_duration:
            ...
            yield {  # Yield entire info
                "frame": cv2.cvtColor(frame, cv2.COLOR_BGR2RGB),
                "gaze_data": gaze_data,
                "face_detected": face_detected,
                "eyes_detected": eyes_detected,
                "blink_detected": False  # Optional enhancement later
            }
